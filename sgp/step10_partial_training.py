...
def main():
    print("🚀 Step 10: Expanded Partial-Training Shell Analysis (Singapore)...")
    ...
    plt.plot(results_df['Training_Ratio'] * 100, results_df['CPC'], marker='o', linestyle='-', color='g')
    plt.axhline(y=0.6764, color='r', linestyle='--', label='Localized Baseline (0.6764)')
    plt.xlabel('Training Set Percentage (%)')
    plt.ylabel('CPC Score')
    plt.title('Singapore Mobility Law: CPC Growth vs. Training Data Ratio')
