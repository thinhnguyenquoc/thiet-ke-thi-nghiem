...
def main():
    print("🚀 Step 3 (Global Scale): Version No POI for ALL zones")
    ...
    # Pre-calculate bin counts for all zones (this is constant)
    # However, N_k actually depends on distance from a specific origin.
    # So we still need to calculate distance per origin.
    ...
    print(f"💾 Saving global No-POI results ({len(results_df)} OD pairs) to {OUTPUT_FILE}...")
    results_df.to_csv(OUTPUT_FILE, index=False)
    print("✅ Step 3 Global complete.")
