...
| **$P(\text{bin}_k|i)$** | Xác suất di chuyển thực nghiệm có điều kiện | Tỷ lệ chuyến đi đến dải $k$ từ gốc $i$ |
...
$$ \hat{T}_{ij} = O_{i} \times P(\text{bin}_{k}|i) \times \frac{A_j}{\sum_{z \in \text{bin}_{k}} A_z} $$
...
$$ \hat{T}_{i1} = O_{i} \times P(\text{bin}_{1}|i) \times \frac{A_{1}}{A_{bin_{1}}} = 1000 \times 0.2 \times \frac{20}{100} = 40 \text{ di chuyển} $$
- Ước lượng số di chuyển đến vùng $j=2$ là $\hat{T}_{i2}$:

$$ \hat{T}_{i2} = O_{i} \times P(\text{bin}_{1}|i) \times \frac{A_{2}}{A_{bin_{1}}} = 1000 \times 0.2 \times \frac{30}{100} = 60 \text{ di chuyển} $$
- Ước lượng số di chuyển đến vùng $j=3$ là $\hat{T}_{i3}$:

$$ \hat{T}_{i3} = O_{i} \times P(\text{bin}_{1}|i) \times \frac{A_{3}}{A_{bin_{1}}} = 1000 \times 0.2 \times \frac{50}{100} = 100 \text{ di chuyển} $$
...
5.  **Attraction-Uniform**: Mô hình vỏ (Shell) 1km đề xuất, phân bổ đều luồng di chuyển.
    $$ \hat{T}_{ij} = O_{i} \times \frac{P(\text{bin}_{k}|i)}{N_k} $$
...
| :--- | :--- | :--- | :--- | :--- |
| Albuquerque | 0.7889 | **0.7949** | 0.6984 (Power) | 0.4895 |
| Arlington | **0.8282** | 0.8263 | 0.7479 (Exp) | 0.6069 |
| Atlanta | **0.7565** | 0.7558 | 0.6775 (Exp) | 0.5400 |
| Austin | 0.4263 | **0.7791** | 0.6649 (Power) | 0.4833 |
| Baltimore | **0.7172** | 0.6958 | 0.6235 (Power) | 0.4681 |
| Boston | 0.6109 | **0.6840** | 0.6320 (Power) | 0.4525 |
| Charlotte | 0.5883 | **0.7847** | 0.6321 (Exp) | 0.4846 |
| Chicago | **0.6831** | 0.6522 | 0.4136 (Exp) | 0.4129 |
| Colorado Springs | **0.8266** | 0.8192 | 0.7376 (Power) | 0.5139 |
| Columbus | 0.6701 | **0.7509** | 0.6237 (Power) | 0.5153 |
| Dallas | 0.5984 | **0.7731** | 0.3869 (Exp) | 0.5158 |
| Denver | 0.5969 | **0.7825** | 0.6768 (Power) | 0.5346 |
| Detroit | 0.6547 | **0.7046** | 0.5526 (Power) | 0.4783 |
| El Paso | 0.7906 | **0.8041** | 0.6879 (Exp) | 0.4970 |
| Fort Worth | 0.8073 | **0.8279** | 0.6792 (Exp) | 0.5679 |
| Fresno | 0.7519 | **0.8166** | 0.7211 (Power) | 0.5372 |
| Houston | 0.4587 | **0.7519** | 0.5055 (Exp) | 0.4862 |
| Indianapolis | 0.6564 | **0.7667** | 0.6542 (Exp) | 0.4909 |
| Jacksonville | 0.5996 | **0.7970** | 0.6788 (Exp) | 0.4989 |
| Kansas City | **0.7965** | 0.7904 | 0.6461 (Exp) | 0.5304 |
| Las Vegas | 0.7317 | **0.7749** | 0.6608 (Exp) | 0.5585 |
| Long Beach | **0.7592** | 0.7490 | 0.6878 (Power) | 0.5469 |
| Los Angeles | 0.6030 | **0.6905** | 0.3477 (Exp) | 0.4284 |
| Louisville | **0.7899** | 0.7712 | 0.7143 (Exp) | 0.5521 |
| Memphis | 0.7390 | **0.7826** | 0.6797 (Power) | 0.4702 |
| Mesa | **0.7992** | 0.7988 | 0.6951 (Exp) | 0.5817 |
| Miami | **0.7576** | 0.7357 | 0.7009 (Exp) | 0.5478 |
| Milwaukee | **0.7355** | 0.7275 | 0.6461 (Power) | 0.4889 |
| Minneapolis | **0.7583** | 0.7338 | 0.7080 (Power) | 0.5435 |
| Nashville | 0.6859 | **0.7881** | 0.6607 (Exp) | 0.4908 |
| New York | 0.5786 | **0.6223** | 0.2966 (Exp) | 0.3353 |
| Oakland | **0.7422** | 0.7227 | 0.6996 (Power) | 0.4989 |
| Oklahoma City | 0.6215 | **0.7705** | 0.6383 (Power) | 0.4829 |
| Omaha | 0.7861 | **0.7918** | 0.7187 (Power) | 0.5068 |
| Philadelphia | 0.6152 | **0.7015** | 0.5592 (Exp) | 0.4233 |
| Phoenix | 0.6647 | **0.7622** | 0.5239 (Exp) | 0.4937 |
| Portland | 0.6439 | **0.7749** | 0.6910 (Power) | 0.5069 |
| Raleigh | **0.8419** | 0.8362 | 0.7220 (Exp) | 0.5759 |
| Sacramento | **0.8006** | 0.7855 | 0.6942 (Exp) | 0.5850 |
| San Antonio | 0.7408 | **0.7774** | 0.6214 (Exp) | 0.4790 |
| San Diego | 0.6512 | **0.7225** | 0.5498 (Exp) | 0.4743 |
| San Francisco | 0.5686 | **0.6769** | 0.6612 (Power) | 0.4099 |
| San Jose | 0.7174 | **0.7593** | 0.6568 (Power) | 0.5112 |
| Seattle | 0.5352 | **0.7549** | 0.6695 (Power) | 0.5138 |
| Tampa | **0.8270** | 0.8119 | 0.6710 (Exp) | 0.5468 |
| Tucson | **0.8210** | 0.8017 | 0.7067 (Power) | 0.4987 |
| Tulsa | **0.8254** | 0.8242 | 0.7233 (Power) | 0.4850 |
| Virginia Beach | 0.7749 | **0.8101** | 0.7035 (Power) | 0.5127 |
| Washington DC | **0.7351** | 0.6856 | 0.6171 (Exp) | 0.4744 |
| Wichita | 0.7838 | **0.8062** | 0.7395 (Power) | 0.5003 |
